 ...
 * Handles images and videos with mobile-friendly video controls
 */
export default function MediaDisplay({ imageUrl, videoUrl, altText = "Media content" }) {
  ...
  // Render video
  if (videoUrl) {
    // FIXED: Better container sizing for posts
    ...
    // FIXED: Better video sizing with proper constraints
    ...
    return (
      <div className={containerClasses}>
        ...
        {/* Video info caption - REMOVED for cleaner look in posts */}
      </div>
    );
  }
