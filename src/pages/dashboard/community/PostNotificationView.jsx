...
export default function PostNotificationView() {
  ...
  return (
    <div className="absolute inset-0 flex flex-col overflow-y-auto w-full max-w-full bg-gray-50 dark:bg-gray-900 transition-colors duration-300 scrollbar-hide" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
      <div className="w-full max-w-3xl mx-auto flex-1 flex flex-col px-2">
