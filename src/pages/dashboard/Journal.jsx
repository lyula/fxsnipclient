    ...
    <div className="w-full max-w-3xl mx-auto p-2 sm:p-4">
      ...
      {showForm && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 w-full max-w-lg mx-2 relative animate-fadeIn">
            <button
            ...
            <h2 className="text-xl font-bold mb-4 text-gray-800 dark:text-gray-100">New Journal Entry</h2>
      ...
      <div className="space-y-6">
        <h2 className="text-xl font-bold mb-2 text-gray-800 dark:text-gray-100">Your Journal Entries</h2>
        {entries.length === 0 ? (
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {entries.map((entry) => (
              ...
              >
                ...
                <div>
                  <span className="font-semibold">Emotions & Confluences:</span>
                  <div className="text-gray-700 dark:text-gray-200 whitespace-pre-line">{entry.emotions}</div>
                </div>
                {entry.confluences && (
                  <div>
                    <span className="font-semibold">Confluences:</span>
